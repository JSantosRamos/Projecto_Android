...
public class InfoVeiculoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int id = (int) getIntent().getLongExtra(ListaMeusVeiculosFragament.VENDA, -1);
        venda = SingletonVenda.getInstance(this).getVenda(id);
    ...
    private void carregarVenda(Venda venda) {
        ...
        Glide.with(InfoVeiculoActivity.this).load(url).placeholder(R.drawable.ic_car_holo_light).diskCacheStrategy(DiskCacheStrategy.ALL).into(ivCarro);
    }
}